...
[`Firmware/WittyPi4_v15/README.md` on the `firmware-rev14` branch](https://github.com/insideoutgrp/Witty-Pi-4/blob/firmware-rev14/Firmware/WittyPi4_v15/README.md)):
