...
# LEGACY (v4.x) line: this repository is Witty-Pi-4 branch main — the
# firmware-agnostic software for devices still on pre-Rev14 firmware.
REPO_RAW='https://raw.githubusercontent.com/insideoutgrp/Witty-Pi-4/main'
# API-side cached mirror (preferred; see vision-service v5.57 notes — site
# NAT IPs get 429-banned by GitHub under fleet probing). The legacy channel
# serves this branch's payload; GitHub direct remains the fallback.
API_SW='https://api.insideoutgroup.co.uk/v1/sw/legacy'
